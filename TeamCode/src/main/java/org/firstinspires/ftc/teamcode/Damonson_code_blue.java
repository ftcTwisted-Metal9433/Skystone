...
@Autonomous (name = "Damonson_code_blue")
public class Damonson_code_blue extends LinearOpMode {
    ...
    public void pointTurnRight( double left, int ms) {
    ...
    public void pointTurnLeft(double right, int ms) {
    ...
    public void openArms() {
        pullyBoi.setPower(-.5);
        servoboiRight.setPosition(90); //-Chris, change the number of the servo cuz the numbers arent correct
        servoboiLeft.setPosition(90);
    }
